...
namespace SpriteDicing.Editors
{
    ...
    public class DicedSpriteAtlasEditor : Editor
    {
        ...
        private static readonly GUIContent trimTransparentContent = new GUIContent("Trim Transparent", "Whether to trim transparent pixels (slack space). Disable to preserve original texture dimensions.");
