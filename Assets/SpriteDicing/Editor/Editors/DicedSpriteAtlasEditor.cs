...
namespace SpriteDicing.Editors
{
    ...
    public class DicedSpriteAtlasEditor : Editor
    {
        ...
        private static readonly GUIContent forcePotContent = new GUIContent("POT", "The generated atlas textures will always have width and height of power of two. Less efficient, but required for some GPUs.");
